...
{% include button.html text="" icon="github" link="https://github.com/lakahaga" %} {% include button.html text="LinkedIn" icon="linkedin" link="www.linkedin.com/in/yerin-choi-a30a4522a" color="#0d94e7" %} 
